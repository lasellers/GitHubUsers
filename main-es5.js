...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _gist_model__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./gist.model */
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function onErrorMessage(error) {
          ...
          var message = "Error: (".concat(error.status, ") (").concat(error.body, ") ").concat(text);
  ...
  function srcAppGistModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Gist = function Gist(content, filename, size, contentUrl, language, url, id, cached, wasCached) {
